...
public class StatePicAndRecAndPreview extends StatePicAndPreview implements MediaRecorder.OnErrorListener, MediaRecorder.OnInfoListener {
    ...
    private final static String TAG = "StatePicAndRecAndPreview";
            ...
            public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                ...
                try {
                    ...
                    if (mMediaRecorder != null) {
                        ...
                        CamLog.e(TAG, "error!!!! mediaRecord is null");
                    }
    ...
    protected void createSurfaces() {
        ...
        try {
            ...
            CamLog.d(TAG, "Video frame " + camPro.videoFrameRate + " bitRate " + camPro.videoBitRate / 2);
