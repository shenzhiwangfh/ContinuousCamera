...
public class IViewDecorator {
    ...
    private final static String TAG = "IViewDecorator";
    ...
    public void setPreviewSize(final int width, final int height) {
        CamLog.d(TAG, "Size: setPreviewSize previewSize " + width + "*" + height);

        if (mViewSurface != null) {
            CamLog.d(TAG, "Size: setPreviewSizeinit camView " + mViewSurface.getWidth() + "*" + mViewSurface.getHeight());
            ...
            mViewTexture.post(new Runnable() {
                @Override
                public void run() {
                    CamLog.d(TAG, "Size: setPreviewSizeinit camView " + mViewTexture.getWidth() + "*" + mViewTexture.getHeight());
